...
//        setBackgroundColor(0xFFFF6347);
        setBackgroundColor(context.getResources().getColor(R.color.orang));
...
//                setBackgroundColor(color);
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        maxNum = array.getInt(R.styleable.RoundIndicatorView_maxNum, 5000);
...
//        canvas.translate(mWidth/2,(mWidth)/2);
        canvas.translate(mWidth/2, (mWidth)/2.8f );
    ...
    private void drawCenterText(Canvas canvas) {
        ...
        canvas.drawText(currentNum+"g", -paint_4.measureText(currentNum+"g")/2, -20, paint_4);
    ...
    private void drawIndicator(Canvas canvas) {
        ...
        Shader shader =new SweepGradient(10, 0, indicatorColor, null);
